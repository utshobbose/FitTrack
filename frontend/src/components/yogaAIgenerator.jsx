...
//   useEffect(() => {
//     const savedPlan = localStorage.getItem("yogaPlan");
//     if (savedPlan) {
...
//         headers: { userid: userId },
//       });
//       // console.log(response.data.yogaPlan); // Debugging line to check the response
//       // setYogaPlan(response.data.yogaPlan);
//       localStorage.setItem("yogaPlan", JSON.stringify(response.data.yogaPlan));
//       setYogaPlan(response.data.yogaPlan);
